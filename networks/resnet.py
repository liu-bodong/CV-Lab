...
# The content is adapted from the code in
# https://github.com/wooseok-shin/PrevMatch


__all__ = ['ResNet', 'make_resnet50', 'make_resnet101']
...
def make_resnet50(pretrained=False, **kwargs):
    return _resnet('resnet50', Bottleneck, [3, 4, 6, 3], pretrained, **kwargs)


def make_resnet101(pretrained=False, **kwargs):
